...
from torchvision.models.densenet import model_urls as densenetmodel_urls
...
class DenseNet121(nn.Module):
	...
	def __init__(self, classCount, isTrained):
		...
		densenetmodel_urls['densenet121'] = densenetmodel_urls['densenet121'].replace('https://', 'http://')
...
class DenseNet169(nn.Module):
	...
	def __init__(self, classCount, isTrained):
		...
		densenetmodel_urls['densenet169'] = densenetmodel_urls['densenet169'].replace('https://', 'http://')
...
class DenseNet201(nn.Module):
	...
	def __init__ (self, classCount, isTrained):
		...
		densenetmodel_urls['densenet201'] = densenetmodel_urls['densenet201'].replace('https://', 'http://')
